...
(function($, window, document) {
	...
	var IndexedList = $.IndexedList = $.Class.extend({
		...
		findElements: function() {
			...
			if(self.el.search==null){
			  self.list_type_simple=true;//简单列表
			  self.el.search=self.box.parentNode.querySelector(classSelector('indexed-list-search'));
			  self.el.searchInput =self.el.search.querySelector(classSelector('indexed-list-search-input'));
			}
