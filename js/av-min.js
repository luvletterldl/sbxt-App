	...
	return function(t) {
		...
		(function(t, n) {
			...
			! function() {
				...
				void 0 === e || e.nodeType ? s._ = m : (void 0 !== n && !n.nodeType && n.exports && (e = n.exports = m), e._ = m), m.VERSION = "1.9.0";
				...
				m.each = m.forEach = function(t, e, n) {
					...
					e = w(e, n);
					for (var r = !N(t) && m.keys(t), i = (r || t).length, s = Array(i), o = 0; o < i; o++) {
						var a = r ? r[o] : o;
						s[o] = e(t[a], a, t)
					}
					return s
				...
				m.reduce = m.foldl = m.inject = j(1), m.reduceRight = m.foldr = j(-1), m.find = m.detect = function(t, e, n) {
					...
					e = w(e, n);
					for (var r = !N(t) && m.keys(t), i = (r || t).length, s = 0; s < i; s++) {
						var o = r ? r[s] : s;
				...
				var k = function(t, e, n, r) {
					r = r || [];
					for (var i = r.length, s = 0, o = T(t); s < o; s++) {
						var a = t[s];
				...
				var I = function(t) {
					return function(e, n, r) {
						n = w(n, r);
						for (var i = T(e), s = t > 0 ? 0 : i - 1; s >= 0 && s < i; s += t)
				...
				m.bind = O(function(t, e, n) {
					...
					var n = function(r) {
						...
						return m.has(i, s) || (i[s] = t.apply(this, arguments)), i[s]
					};
					return n.cache = {}, n
				...
				var D = !{
					...
					L = function(t, e) {
						var n = F.length,
							...
							s = "constructor";
						for (m.has(t, s) && !m.contains(e, s) && e.push(s); n--;)(s = F[n]) in t && t[s] !== i[s] && !m.contains(e, s) && e.push(s)
					};
				m.keys = function(t) {
					if (!m.isObject(t)) return [];
					if (_) return _(t);
				...
				m.pick = O(function(t, e) {
					var n = {},
						r = e[0];
					if (null == t) return n;
					m.isFunction(r) ? (e.length > 1 && (r = b(r, e[1])), e = m.allKeys(t)) : (r = M, e = k(e, !1, !1), t = Object(t));
				...
				m.mixin = function(t) {
					return m.each(m.functions(t), function(e) {
						...
						m.prototype[e] = function() {
							var t = [this._wrapped];
							return l.apply(t, arguments), Y(this, n.apply(m, t))
						}
					}), m
		...
		var r = n(0),
			...
			v = function(t) {
				...
				var v = u._config.requestTimeout,
					y = _({
						service: e,
						path: s,
						version: n
					});
				return p(l, d).then(function(t) {
					return h({
						method: i,
						url: y,
						query: o,
						...
						e.rawMessage = e.rawMessage || e.error, u._sharedConfig.keepErrorRawMessage || (e.error += " [" + (t.statusCode || "N/A") + " " + i + " " + y + "]");
		...
		var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
			...
			f = function(t) {
				var e = t.method,
					...
					_ = t.timeout,
					v = h++;
				u("request(" + v + ")", e, n, r, s, d);
				var y = {};
				if (r)
					for (var m in r) "object" === i(r[m]) ? y[m] = JSON.stringify(r[m]) : y[m] = r[m];
				return new l(function(t, i) {
					var l = o(e, n).set(d).query(y).send(s);
		...
		n(15);
		var r = n(5);
		r._ = n(0), r.version = n(9), r.Promise = n(1), r.localStorage = n(11), r.Cache = n(12), r.Error = n(4), n(30), n(32)(r), n(33)(r), n(34)(r), n(35)(r), n(36)(r), n(37)(r), n(45)(r), n(46)(r), n(47)(r), n(48)(r), n(49)(r), n(51)(r), n(52)(r), n(53)(r), n(54)(r), n(55)(r), n(56)(r), r.Conversation = n(57), t.exports = r
	}, function(t, e, n) {
		"use strict"
	}, function(t, e) {
		...
		function i(t) {
			...
			var i;
			return n.namespace = t, n.enabled = e.enabled(t), n.useColors = e.useColors(), n.color = r(t), n.destroy = s, "function" == typeof e.init && e.init(n), e.instances.push(n), n
		}
			...
			! function(e, n) {
				...
				function S(t, e, n, r) {
					var i = t._subscribers,
						s = i.length;
					t._onerror = null, i[s] = e, i[s + Y] = n, i[s + Z] = r, 0 === s && t._state && J(A, t)
				}
		...
		i.init = function(t) {
			...
			o && console.warn("MasterKey is not supposed to be used in browser."), i._config.applicationId = e, i._config.applicationKey = n, i._config.masterKey = o, void 0 !== _ && (i._config.production = _), void 0 !== p && (i._config.disableCurrentUser = p), i._appRouter = new s(i);
			var y = f || void 0 !== d || "cn" !== u;
			i._setServerURLs(c({}, r(e, u), i._config.serverURLs, "string" == typeof d ? h(d) : d), y), v ? i._config.realtime = v : i._sharedConfig.liveQueryRealtime && (i._config.realtime = new i._sharedConfig.liveQueryRealtime({
				appId: e,
				appKey: n,
				region: u
			}))
		...
		t.exports = function(t) {
			t.Object = function(e, n) {
				...
				escape: function(t) {
					...
					return n = l(r) ? "" : s.escape(r.toString()), this._escapedAttributes[t] = n, n
				},
				has: function(t) {
				...
				_applyOpSet: function(e, n) {
					...
					t._objectEach(e, function(e, s) {
						var o = p(n, s),
							...
							c = a[1],
							l = a[2];
						d(n, s, e._estimate(u, r, s)), c && c[l] === t.Op._UNSET && delete c[l]
					})
				},
					...
					delete this.attributes[e], this._serverData[e] && (this.attributes[e] = this._serverData[e]), t._arrayEach(this._opSetQueue, function(r) {
						...
						if (s) {
							var o = p(n.attributes, e),
								...
								l = a[2],
								h = a[3];
							d(n.attributes, e, s._estimate(u, n, e)), c && c[l] === t.Op._UNSET && delete c[l], n._resetCacheForKey(h)
						}
					})
				},
				...
				set: function(e, n, r) {
					var i;
					if (s.isObject(e) || l(e) ? (i = s.mapObject(e, function(e, n) {
							return m(n), t._decode(e, n)
						}), r = n) : (i = {}, m(e), i[e] = t._decode(n, e)), r = r || {}, !i) return this;
				...
				fetch: function() {
					var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
						e = arguments[1],
						n = this;
					return u("classes", this.className, this.id, "GET", f(t), e).then(function(e) {
						var r = n.parse(e);
				...
				save: function(e, n, r) {
					var i, o, a;
					s.isObject(e) || l(e) ? (i = e, a = n) : (i = {}, i[e] = n, a = r), a = s.clone(a) || {}, a.wait && (o = s.clone(this.attributes));
					var c = s.clone(a) || {};
					c.wait && (c.silent = !0), i && this.set(i, c);
					var h = this,
						f = [],
						d = [];
					return t.Object._findUnsavedChildren(h, f, d), f.length + d.length > 1 ? t.Object._deepSaveAsync(this, h, a) : (this._startSave(), this._saving = (this._saving || 0) + 1, this._allPreviousSaves = this._allPreviousSaves || t.Promise.resolve(), this._allPreviousSaves = this._allPreviousSaves.catch(function(t) {}).then(function() {
						var t = h.id ? "PUT" : "POST",
							e = h._getSaveJSON(),
							n = {};
						if ((h._fetchWhenSave || a.fetchWhenSave) && (n.new = "true"), a.query) {
							var r;
							if ("function" == typeof a.query.toJSON && (r = a.query.toJSON()) && (n.where = r.where), !n.where) {
						...
						var l = "classes",
							f = h.className;
						"_User" !== h.className || h.id || (l = "users", f = null);
						var d = a._makeRequest || u,
							p = d(l, f, h.id, t, e, a, n);
						return p = p.then(function(t) {
							var e = h.parse(t);
							return a.wait && (e = s.extend(i || {}, e)), h._finishSave(e), a.wait && h.set(o, c), h
						}, function(t) {
				...
				var i = [],
					a = [];
				t.Object._findUnsavedChildren(e, i, a);
				...
				return c.then(function() {
					return t.Promise._continueWhile(function() {
						...
						if (t._arrayEach(h, function(t) {
							...
							}), h = n, 0 === e.length) return t.Promise.reject(new o(o.OTHER_CAUSE, "Tried to save a batch with a cycle."));
						var i = t.Promise.resolve(s.map(e, function(e) {
		...
		t.exports = function(t) {
			t.User = t.Object.extend("_User", {
				...
				_unlinkFrom: function(t) {
					return console.warn("DEPRECATED: User#_unlinkFrom å·²åºŸå¼ƒï¼Œè¯·ä½¿ç”¨ User#dissociateAuthData ä»£æ›¿"), this.dissociateAuthData(t)
				},
				...
				follow: function(e, n) {
					...
					var u = "users/" + this.id + "/friendship/" + o;
					return a(u, null, null, "POST", t._encode(s), n)
				},
				unfollow: function(t, e) {
					...
					return a(s, null, null, "DELETE", null, e)
				},
				...
				associateWithAuthData: function(t, e, n) {
					return console.warn("DEPRECATED: User.associateWithAuthData å·²åºŸå¼ƒï¼Œè¯·ä½¿ç”¨ User#associateWithAuthData ä»£æ›¿"), t._linkWith(e, n)
				},
				logOut: function() {
				...
				resetPasswordBySmsCode: function(t, e) {
					return a("resetPasswordBySmsCode", null, t, "PUT", {
						password: e
					})
				},
				...
				_saveCurrentUser: function(e) {
					var n;
					return n = t.User._currentUser !== e ? t.User.logOut() : c.resolve(), n.then(function() {
		...
		t.exports = function(t) {
			t.LiveQuery = a(i, {
				...
				init: function(e) {
					var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
						r = n.subscriptionId,
						i = void 0 === r ? t._getSubscriptionId() : r;
					...
					return s.resolve(i).then(function(n) {
						return t._config.realtime.createLiveQueryClient(n).then(function(r) {
							var i = e.toJSON(),
								...
								c = l(u, n).then(function(e) {
									var i = e.query_id;
									return new t.LiveQuery(i, r, u, n)
								}).finally(function() {
									r.deregister(c)
								});
